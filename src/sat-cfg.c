...
#define SINGLE_SAT_FIELD_DEF (SINGLE_SAT_FLAG_AZ |\
    ...
    SINGLE_SAT_FLAG_SKR_DOWN |\
    SINGLE_SAT_FLAG_SKR_UP)
...
#define SECOND_SAT_FIELD_DEF (SECOND_SAT_FLAG_AZ |\
    ...
    SECOND_SAT_FLAG_SKR_DOWN |\
    SECOND_SAT_FLAG_SKR_UP)

#define TWO_SAT_FIELD_DEF (TWO_SAT_FLAG_AZ |\
    TWO_SAT_FLAG_EL |\
    TWO_SAT_FLAG_RANGE |\
    TWO_SAT_FLAG_RANGE_RATE |\
    TWO_SAT_FLAG_NEXT_EVENT |\
    TWO_SAT_FLAG_SSP |\
    TWO_SAT_FLAG_FOOTPRINT |\
    TWO_SAT_FLAG_ALT |\
    TWO_SAT_FLAG_VEL |\
    TWO_SAT_FLAG_DOPPLER |\
    TWO_SAT_FLAG_LOSS |\
    TWO_SAT_FLAG_DELAY |\
    TWO_SAT_FLAG_MA |\
    TWO_SAT_FLAG_PHASE |\
...
//  {"MODULES", "VIEW_6", GTK_SAT_MOD_VIEW_MULTIPLE},   /* FIXME */
    ...
    {"MODULES", "TWO_SAT_REFRESH", 1},
    {"MODULES", "TWO_SAT_FIELDS", TWO_SAT_FIELD_DEF},
    {"MODULES", "TWO_SAT_SELECTED_FIRST", 0},
    {"MODULES", "TWO_SAT_SELECTED_SECOND", 0},
